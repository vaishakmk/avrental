...
import com.group4.cloud.dao.VehicleRepository;
import com.group4.cloud.service.VehicleServices;
...
public class VehicleController {
	...
	public ResponseEntity<Object> updateVehicle(@RequestBody Vehicle vehicle) {
		 ...
		 * vehicleRepository.findById(vehicle.getVehicleid()); if
		 * (!vehicleOptional.isPresent()) return ResponseEntity.notFound().build();
		 * vehicle.setStatus(vehicle.getStatus()); vehicleRepository.save(vehicle);
		 */
